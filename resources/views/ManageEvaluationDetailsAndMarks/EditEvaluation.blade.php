...
<head>
    <title>Edit Evauation | PSMES</title>
</head>
...
@section('content')
    ...
    <form style="width:100%;" action="{{url('update/'.$evaluation_data->id)}}" method="POST">
    @csrf
    @method('PUT')
    <center>
    <div style="width: 60%">
        ...
        <tr style="height: 60px;">
            ...
            <td style="width:50%"><input name="std_name" type="text" value="{{$evaluation->std_name}}" class="form-control" id="exampleFormControlInput2" placeholder="Enter Student Name"></td>
        </tr>
        <tr style="height: 60px;">
            <td style="width:10%; margin-left:15px;"><label for="exampleFormControlInput3" class="form-label">Supervisor Name</label></td>
            <td style="width:50%"><input name="sv_name" type="text" value="{{$evaluation->sv_name}}" class="form-control" id="exampleFormControlInput3" placeholder="Enter Supervisor Name"></td>
        </tr>
        <tr style="height: 60px;">
            <td style="width:10%; margin-left:15px;"><label for="exampleFormControlInput4" class="form-label">Evaluator Name</label></td>
            <td style="width:50%"><input name="eva_name" type="text" value="{{$evaluation->eva_name}}"  class="form-control" id="exampleFormControlInput4" placeholder="Enter Evaluator Name"></td>
        </tr>
        <tr style="height: 60px;">
            <td style="width:10%; margin-left:15px;"><label for="exampleFormControlInput5" class="form-label">Evaluation Date</label></td>
            <td style="width:50%"><input name="eva_date" type="text" value="{{$evaluation->eva_date}}" class="form-control" id="exampleFormControlInput5" placeholder="Enter Evaluation Time"></td>
        </tr>
        <tr style="height: 60px;">
            <td style="width:10%; margin-left:15px;"><label for="exampleFormControlInput5" class="form-label">Evaluation Time</label></td>
            <td style="width:50%"><input name="eva_time" type="text" value="{{$evaluation->eva_time}}" class="form-control" id="exampleFormControlInput5" placeholder="Enter Evaluation Date"></td>
        </tr>
        </table> 
