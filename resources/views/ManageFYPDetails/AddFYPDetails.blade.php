...
@section('content')
        ...
        <div style="margin-top: 15px; padding:10px 16px; height:100%;background-color: #F5F5F5;">
            ...
            <h2 style="height: 40px;  color: #FFFFFF; font-size: 18px; padding: 10px 10px; background-color:#11ADA4; text-align: center;">Add New Student FYP Details</h2>
    ...
    <tr style="height: 60px;">
        ...
        <td><input style="width:70%;"  name="std_name" type="text" class="form-control"  placeholder="Enter Student Name"></td>
    </tr>
    <tr style="height: 60px;">
        <td><label class="form-label">Supervisor Name</label></td>
        <td><input style="width:70%; " name="sv_name" type="text" class="form-control" placeholder="Enter Supervisor Name"></td>
    </tr>
    <tr style="height: 60px;">
        <td><label class="form-label">Evaluator Name</label></td>
        <td><input style="width:70%; " name="eva_name" type="text"  class="form-control" placeholder="Enter Evaluator Name"></td>
    </tr>
    <tr style="height: 60px;">
        <td><label class="form-label">FYP Title</label></td>
        <td><input style="width:70%; " name="fyp_title" type="text" class="form-control" placeholder="Enter FYP Title"></td>
    </tr>
    </table> 
