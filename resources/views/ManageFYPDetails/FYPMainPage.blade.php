...
@if(session('success'))
    ...
    <div style="margin: 0px 0px; padding:0px 0px;height:90%; background-color: white;">
        ...
        <h2 style="height: 40px;  color: #FFFFFF; font-size: 18px; padding: 10px 10px; background-color:#11ADA4; text-align: center;">Add Student FYP Details</h2>
        ...
        <h2 style="height: 40px; color: #FFFFFF; margin-bottom: 100px; font-size: 18px; padding: 10px 10px; background-color:#11ADA4; text-align: center;">Update FYP Details</h2>
           
        <div>

        <form type="get" action="{{url('/fypdata/search')}}">
            
            <center><h style="font-size: 20px;" >Student ID : </h><br><br><input class="form-control mr-sm-2 my-lg-0" name="query" style="border: 5px solid #11ADA4;  width: 50%; text-align: center;" type="search" placeholder="Enter student ID" size="100" ><center>
