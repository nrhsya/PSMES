        ...
        <div class=" mb-5" style="background-color:#11ADA4;padding:10px;color:white;width:100%;">
            ...
            <form action="/rubricdata/create" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="weak_grade"  type="text" class="form-control" id="exampleFormControlInput1"  placeholder="Enter Weak Grade"></textarea>
                        </div>
						
						 <!-- vweak_grade -->
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Very Weak Grade</label>
                            <textarea name="vweak_grade" type="text" class="form-control" id="exampleFormControlInput1"  placeholder="Enter Very Weak Grade"></textarea>
                        </div>
						
							 <!-- fail_grade -->
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Fail Grade</label>
                            <textarea name="fail_grade"  type="text" class="form-control" id="exampleFormControlInput1" placeholder="Enter Fail Grade"></textarea>
                        </div>
						
							 <!-- weightage -->
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Weightage</label>
                            <textarea name="weightage"  type="text" class="form-control" id="exampleFormControlInput1"  placeholder="Enter Weightage"></textarea>
                        </div>
						
						<!-- mark_given -->
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Mark Given</label>
                            <textarea name="mark_given"  type="text" class="form-control" id="exampleFormControlInput1"  placeholder="Enter Mark Given"></textarea>
                        </div>
						
						<!-- final_percent -->
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Final Percent</label>
                            <textarea name="final_percent"  type="text" class="form-control" id="exampleFormControlInput1"  placeholder="Enter Final Percent"></textarea>
                        </div>
